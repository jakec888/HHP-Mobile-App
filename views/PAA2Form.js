...
export class PAA2Form extends Component {
  render() {
    return (
      <Container>
          ...
          <Form>
            <Item picker>
              <Picker
                ...
                onValueChange={this.props.onChangeApplicant}>
            ...
            <Item picker>
              <Picker
                ...
                onValueChange={this.props.onChangeAgeRange}>
            ...
            <Item picker>
              <Picker
                ...
                onValueChange={this.props.onChangeReference}>
                <Picker.Item
            ...
            <Item picker>
              <Picker
                ...
                onValueChange={this.props.onChangeService}>
                <Picker.Item
            ...
            <Item picker>
              <Picker
                ...
                onValueChange={this.props.onChangeIssue}>
                <Picker.Item
